...
export const MintButton = ({
    ...
    return (
        <button
            className='!border-solid !border-2 md:!border-[3.5px] !border-primary !rounded-md !p-0 !bg-transparent !flex !flex-row !flex-nowrap !text-sm sm:!text-base !items-center !justify-center !font-normal text-white px-3 font-header text-xs sm:text-sm md:text-lg whitespace-nowrap -ml-3 only:ml-0'
